                    ...
                    <div class="row">
                        <template v-for="(form_field, index) in form_fields" v-bind:key="index">
                            <div :class="form_field.row_col_class ? form_field.row_col_class : `col-md-6`">
                                <common-input :readonly="true" :label="form_field.label" :type="form_field.type" :name="form_field.name"
                        ...
                        <div class="col-md-12" v-if="is_loaded">
                            <div class="form-group mt-4">
                                <label for="">Reply for this message</label>
                                <div class="mt-1 mb-3">
                                    ...
                                    <textarea class="d-none" name="reply_message"
