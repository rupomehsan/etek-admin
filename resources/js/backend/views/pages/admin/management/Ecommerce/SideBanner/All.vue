                                    ...
                                    <tr v-for="(item) in all?.data" :key="item.id"
                                        ...
                                        <td>
                                            <img height="50" width="50"
                                                :src="`${load_image(item.banner_one) ?? '/avatar.png'} `" alt="">
                                        </td>
                                        <td>
                                            <img height="50" width="50"
                                                :src="`${load_image(item.banner_two) ?? '/avatar.png'} `" alt="">
                                        </td>
                                        <td>
                                            <img height="50" width="50"
                                                :src="`${load_image(item.banner_three) ?? '/avatar.png'} `" alt="">
                                        </td>
                                        <td>
                                            <img height="50" width="50"
                                                :src="`${load_image(item.banner_four) ?? '/avatar.png'} `" alt="">
                                        </td>
                                        <td>
                                            {{ item.status ?? 'N/A' }}
                                        </td>
